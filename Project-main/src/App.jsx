...
>>>>>>> 94bd6a69ae49bfa0d15a436eb9a044b355c5add7
...
<<<<<<< HEAD
				<Route
					...
					/>
					<Route
						path='/VetClinicFinder'
						element={<VetClinicFinder />}
					/>
					<Route
					...
					/>
					<Route
						path='/AdoptionPredictor'
						element={<AdoptionPredictor />}
					/>
					<Route
						path='/PetPricePredictor'
						element={<PetPricePredictor />}
					/>
					<Route
						path='/PetChecker'
						element={<PetChecker />}
