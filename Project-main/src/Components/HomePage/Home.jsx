  ...
  return (
    <div className="home-container">
      ...
      <section className="hero">
        <div className="hero-text">
          ...
          <div className="hero-buttons">
            <Link to="/adopt" className="hero-btn"><GiDogHouse />Adoption</Link>
            <Link to="/supplies" className="hero-btn"><MdShoppingCart />Supplies</Link>
      ...
      <section className="adopt-section section">
        ...
        <Link to="/adopt"><button className="show-more">Show more</button></Link>
      </section>
      ...
      <section className="care-section section">
        <div className="care-text">
          ...
          <p>Explore our high-quality food, toys, and accessories to keep them happy and healthy.</p>
          <div className="postionbtn"><Link to="/care" className="explore-btn">Explore</Link></div>
        </div>
      ...
      <section className="forum-section">
        <div className="forum-text">
          ...
          <div className="postionbtn2"><Link to="/forum" className="explore-btn-2">Explore</Link></div>
        </div>
      ...
      <section className="clinic-section section">
        <div className="clinic-text">
          ...
          <p>Find the nearest vet clinic easily. Get quick access to trusted care for check-ups, vaccinations, and emergencies</p>
          
          <div className="doctor-image">
          <img src={doctorImg} alt="Doctor" />
          <Link to="/clinics"><button className="explore-btn">Find Clinic</button></Link>
        </div>
      ...
      <section className="ai-section section">
        <div className="ai-text">
          ...
          <p className="ai-text-p">Our AI Pet Care Section brings the latest in smart technology to help you take care of your furry friends with ease. Discover innovative AI solutions for training, health tracking, and pet well-being!</p>
          <div className="ai-ptn"><Link to="/ai"><button className="explore-btn">Discover AI</button></Link></div>
        </div>
