...
export default function UploadPetPage() {
  const [fileName, setFileName] = useState(
    "The first image it will be the hero image"
  );
  ...
  function handleSubmit(e) {
    ...
    fetch("http://localhost:3001/pets", {
      ...
      .then((res) => res.json())
      .then((data) => {
        setBtnText(data.message || "Pet data uploaded successfully!");
  ...
  return (
    <>
      <h1
        style={{ margin: "60px 0 60px 30px" }}
        className="text-[#323773] text-5xl text-center md:text-start font-semibold my-7"
      >
        Upload Animal Data
      </h1>
      <form
        style={{ margin: "60px 50px", paddingInline: "20px" }}
        className=""
      ...
      >
        <div className="md:flex-row flex flex-col md:justify-center md:gap-30 md:items-start">
          <div
            ...
            className="flex flex-col gap-3 md:basis-[45%]"
          >
            ...
            >
              <input
                ...
                value="Male"
                onChange={handleChange}
                style={{ width: "20px", margin: "0 0 0 10px", height: "20px" }}
                type="radio"
                id="male"
              />
              ...
              <input
                ...
                value="Female"
                onChange={handleChange}
                style={{ width: "20px", margin: "0 0 0 100px", height: "20px" }}
                type="radio"
                id="female"
              />
          ...
          <div
            style={{ marginBottom: "30px" }}
            className="flex flex-col gap-3 basis-[45%]"
          >
            <label className="text-black text-lg font-semibold">
              Upload Pet Image:
            </label>
            ...
            >
              <h3
                ...
                className="text-2xl font-semibold p-2.5"
              >
                Image Upload
              </h3>
              <label
              ...
              <span style={{ marginLeft: "30px" }}>
                {images.map((i) => <span key={i.name}>{i.name} + </span>) ||
                  "No file chosen"}
              </span>
            </div>
            <h1
              style={{ margin: "90px 0 20px 0" }}
              className="text-2xl text-[#323773] font-semibold"
            >
              Owner Data:
            </h1>
        ...
        <button
          type="submit"
          style={{ margin: "auto", width: "60%", padding: "10px 0" }}
          className="bg-[#323773] text-white rounded-md block"
        >
          {btnText}
        </button>
      </form>
